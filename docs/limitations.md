...
| **런타임 차단 증적** | Falco·Cilium 룰 배치 완료 | DROPPED/차단 *이벤트* 증적 미수집 | 시나리오 #8에서 차단 로그 캡처 |
...
| **이미지 서명** | 미적용 | 공급망 무결성 *검증* 부재 | cosign 서명 + 배포 시 admission 검증 |
...
flowchart LR
    subgraph S["단기 · 1–2주"]
        ...
        A2["런타임 차단 증적<br/>(Falco/Cilium DROPPED)"]
    end
    subgraph M["중기 · 1–2개월"]
...
| 우선순위 | 과제 | 근거 |
| --- | --- | --- |
| **P1 (단기)** | DAST 4/4, 런타임 차단 증적 | 계층방어 정량 근거의 마지막 빈칸 |
